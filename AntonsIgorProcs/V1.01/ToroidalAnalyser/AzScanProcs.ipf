...
if(CheckName("AzScanPanel", 9,"AzScanPanel"))
	...
	NewPanel /W=(1057,120,1402,750) as "AzScanPanel"
	...
	PopupMenu AzParam10,pos={10,99},size={175,21},bodyWidth=175,proc=AzScanEmissionAngleChange
	PopupMenu AzParam10,mode=2,popvalue="Use Negative Polar Angles",value= #"\"Use Both Emission Directions;Use Negative Polar Angles Only;Use Positive Polar Angles Only\""
	...
	Button button0,pos={15,254},size={75,20},proc=SaveFPlotSettings,title="Save Settings"
	Button button1,pos={95,254},size={75,20},proc=GetFPlotSettings,title="Get Settings"
	...
	CheckBox UseFullrangeChk,pos={27,226},size={109,14},proc=FullRangeAzCheckProc,title="Use Full Phi Range"
	CheckBox UseFullrangeChk,value= 0
