...
Macro FermiFitPanel() : Panel
	...
	if(CheckName("FermiFitPanel", 9,"FermiFitPanel"))
		...
		Newdatafolder/O/S :FermiFitPanelGlobs
		
		variable/g FFPosVAL = root:Packages:FermiFitPanelGlobs:FFposVAL
		variable/g FFwidthVAL = root:Packages:FermiFitPanelGlobs:FFWidthVAL
		variable/g FFPolyorderVAL = root:Packages:FermiFitPanelGlobs:FFposVAL
		variable/g FFtempVAL = root:Packages:FermiFitPanelGlobs:FFtempVAL
